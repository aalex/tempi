...
void ParticleGenerator::onDraw()
{
    ...
    clutter_actor_set_z_rotation_from_gravity(particle, g_rand_double_range(random_generator_, -360.0, 360.0), CLUTTER_GRAVITY_CENTER);
    ClutterAnimation *animation = clutter_actor_animate(particle, CLUTTER_LINEAR, duration, 
        ...
        "height", 0.0f,
        "opacity", 0,
        "rotation-angle-z", g_rand_double_range(random_generator_, -360.0, 360.0),
